...
import com.heimat.albumselectlibrary.model.LocalMediaFolder;
...
public abstract class ImageSelectorActivity extends AppCompatActivity {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (permissions.length > 0) {
            if (permissions[0].equals(Manifest.permission.CAMERA)) {
                ...
                Toast.makeText(this, "您拒绝了拍照权限，将不能进行拍照！", Toast.LENGTH_SHORT);
            }
        }
    }
    ...
    public void startPreview(List<LocalMedia> previewImages, int position) {
        ImagePreviewActivity.startPreview(ImageSelectorActivity.this, previewImages, imageAdapter.getSelectedImages(), maxSelectNum, position);
    }
