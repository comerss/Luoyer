...
import com.qiezzi.choseviewlibrary.listener.OnDismissListener;
import com.qiezzi.choseviewlibrary.utils.PickerViewAnimateUtil;
...
public class BasePickerView extends View{
    ...
    public void setTransparentBg(){
        rootView.setBackgroundColor(context.getResources().getColor(R.color.bgColor_overlay2));
    }
}
