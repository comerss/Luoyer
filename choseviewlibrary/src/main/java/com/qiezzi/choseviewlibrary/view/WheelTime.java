...
import com.qiezzi.choseviewlibrary.TimePickerView;
import com.qiezzi.choseviewlibrary.adapter.ArrayWheelAdapter;
import com.qiezzi.choseviewlibrary.adapter.NumericWheelAdapter;
...
public class WheelTime {
    ...
    public static DateFormat mFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm");
    private View view;
...
//		wv_hours.setLabel(context.getString(R.string.pickerview_hours));// 添加文字
        ...
        cMin = (WheelView) view.findViewById(R.id.cMin);
...
//		wv_mins.setLabel(context.getString(R.string.pickerview_minutes));// 添加文字
        ...
        if (type == TimePickerView.Type.CUSTOM) {
            ...
            cMin.setAdapter(new ArrayWheelAdapter(mMinutes));
            Date date = new Date();
            Log.i("hours", "hours------>" + date.getHours());
            if (date.getMinutes() < 30) {
                cMin.setCurrentItem(date.getHours() * 2 + 1);
            } else {
                cMin.setCurrentItem(date.getHours() * 2 + 2);
            }
        }
    ...
    public String getTime() {
        ...
        if (mMinutes != null) {
            sb.append((wv_year.getCurrentItem() + startYear)).append("-")
                    ...
                    .append(mMinutes.get(cMin.getCurrentItem()));
    ...
    public void setOnTimeChangListener(OnTimeChangeListener onTimeChangListener) {
        mOnTimeChangeListener = onTimeChangListener;
    }
}
