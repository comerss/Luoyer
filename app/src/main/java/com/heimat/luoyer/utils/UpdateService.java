...
public class UpdateService extends Service {
    ...
    /*<!--更新服务-->*/
    String prepare = "preparing to download";
    String progress = "downloading %1$d%2$s";
    String success = "download success(click install)";
    String error = "download fail(click to use the browser to download)";
    ...
    private void buildNotification() {
        ...
        builder.setContentTitle(prepare)
    ...
    private void start() {
        ...
        builder.setContentText(prepare);
        manager.notify(notifyId, builder.build());
    }
    ...
    private void update(int progress) {
        if (progress - lastProgressNumber > updateProgress) {
            ...
            builder.setContentText(getString(progress, progress, "%"));
            manager.notify(notifyId, builder.build());
        }
    }
...
/*
* 使用详解
*  UpdateService.Builder.create(url)//获取下载路径url
