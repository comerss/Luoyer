...
public class HttpHelper {
    ...
    public static <T> void doPost(Context context, final int flag, final String url, Map<String,
...
//        }
    ...
    private static <T> void doResult(Map response, HttpCallBack<T> httpCallBack, int flag, Class<T> clazz, Object loadingDialog,String url,String json) {
        if(response!=null){
